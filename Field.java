...
public class Field{
  ...
  public void update(){
    for(Entity en: team1){
      try{
        ...
        ((Player)en).manageException(this);
        // add code here
      }
    }
    for(Entity en: team2){
  ...
  //CODE BY ESRA'A==================================================================================
  public boolean winGame(Player a,String teamColour){
    //GOT NULL POINTER EXCEPTION ONCE !!!!!===========================================================
    Entity b=base1;
    if(teamColour.equals("reds")){
      b=base2;
    ...
    if(pickUpFlag(a)) {
      ...
      if (Math.hypot(a.x - b.x, a.y - b.y) <= ARMS_LENGTH) {
        System.out.println("-----------------------------------------------------------");
        GAME_IS_WON = true;
        return true;
      }
