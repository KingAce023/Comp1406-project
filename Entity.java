...
//  throw new EntityOutOfBoundsException("out of bounds");
  ...
  protected void checkCoordinates(Field field) throws EntityOutOfBoundsException{
    ...
    if((this.x + this.speedX + this.sprite.getWidth() > field.maxX) ||
       (this.x + this.speedX < field.minX)                          ||
       (this.y + this.speedY + this.sprite.getHeight() > field.maxY) ||
       (this.y + this.speedY < field.minY)){
     throw new EntityOutOfBoundsException("out of bounds"); 
    }
  }
